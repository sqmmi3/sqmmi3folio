...
<template>
  <div>
    <div class="min-h-[80vh] flex flex-col items-center justify-center px-6 text-center">
      <h1
        class="animate-reveal hover-glitch text-6xl md:text-8xl font-black text-white tracking-tighter mb-4"
        data-text="I AM SQMMI3"
      >
        I AM
        <RouterLink to="/about" class="text-emerald-500 drop-shadow-[0_0_20px_rgba(16,185,129,0.7)]"
          >SQMMI3</RouterLink
        >
      </h1>
      ...
      <RouterLink
        to="/projects"
        class="animate-reveal-delay-long mt-15 px-8 py-4 bg-emerald-600 text-black rounded-full font-bold hover:bg-emerald-400 hover:shadow-[0_0_40px_rgba(16, 185,129,0.6)] transition-all duration-500 transform hover:scale-105"
      >
        Initialise Viewport
      </RouterLink>
    </div>
    ...
    <section class="max-w-6xl mx-auto py-20 px-6">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div
          class="group p-8 rounded-2xl bg-white/5 border border-white/10 hover:border-emerald-500/50 transition-all duration-500 animate-in backdrop-blur-xs"
    ...
    <section class="max-w-4xl mx-auto py-32 px-6">
      <div
        class="bg-white/5 border border-emerald-500/20 rounded-lg p-6 backdrop-blur-xl relative overflow-hidden animate-in"
      ...
      >
        ...
        <div class="font-mono text-sm space-y-2">
          <p class="text-emerald-400">
            ><span class="text-white"> CURRENT_LOCATION:</span> Emerald_Galaxy_v4.0
          </p>
          <p class="text-emerald-400">
            ><span class="text-white"> RECENT_BEAT:</span> hyperpop_draft_09.wav
          </p>
          <p class="text-emerald-400">
            ><span class="text-white"> HARDWARE_STATUS:</span> ESP32_Online
          </p>
          <p class="text-emerald-400 animate-pulse">
            > <span class="permanent-glitch"> SYSTEM_ACTIVE...</span>
          </p>
        </div>
      </div>
    </section>
    ...
    >
      <div
        class="flex animate-marquee gap-10 text-emerald-400/50 font-black uppercase tracking-widest text-xl"
      >
        <span>Brakence</span> <span>React</span> <span>IoT</span> <span>Jeremy Zucker</span>
        <span>C++</span> <span>EDEN</span> <span>Flutter</span> <span>React Native</span>
        <span>Chelsea Cutler</span> <span>C#</span> <span>Keshi</span> <span>Full-Stack</span>
        <span>Java</span> <span>Guitar</span> <span>Ruel</span> <span>Figma</span>
        <span>VR/AR</span> <span>Indie/Alternative</span> <span>bixby</span> <span>Godot</span>
        <span>Singing</span> <span>Shaders</span> <span>Python</span> <span>JS/TS</span>
        <span>starfall</span> <span>VueJS</span> <span>HTML/CSS</span> <span>Arctic Monkeys</span>
        <span>(No)SQL</span> <span>Godot</span> <span>Unity</span> <span>50landing</span>
        <span>DJO</span> <span>Joji</span> <span>Cigarettes After Sex</span> <span>Brakence</span>
        <span>React</span> <span>IoT</span> <span>Jeremy Zucker</span> <span>C++</span>
        <span>EDEN</span> <span>Flutter</span> <span>React Native</span> <span>Chelsea Cutler</span>
        <span>C#</span> <span>Keshi</span> <span>Full-Stack</span> <span>Java</span>
        <span>Guitar</span> <span>Ruel</span> <span>Figma</span> <span>VR/AR</span>
        <span>Indie/Alternative</span> <span>bixby</span> <span>Godot</span> <span>Singing</span>
        <span>Shaders</span> <span>Python</span> <span>JS/TS</span> <span>starfall</span>
        <span>VueJS</span> <span>HTML/CSS</span> <span>Arctic Monkeys</span> <span>(No)SQL</span>
        <span>Godot</span> <span>Unity</span> <span>50landing</span> <span>DJO</span>
        <span>Joji</span> <span>Cigarettes After Sex</span>
      </div>
    </div>
  </div>
</template>
